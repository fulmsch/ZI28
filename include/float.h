...
extern double_t __LIB__ fmod(double_t,double_t);
extern double_t __LIB__ amax(double_t,double_t);
extern double_t __LIB__ fabs(double_t);
extern double_t __LIB__ amin(double_t,double_t);
extern double_t __LIB__ floor(double_t);
extern double_t __LIB__ ceil(double_t);
 ...
 */
extern void __LIB__ ftoa(double_t, int, char *);
extern void __LIB__ ftoe(double_t, int, char *);
