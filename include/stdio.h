...
extern FILE __LIB__ *fopen(const char *name, const char *mode);
extern FILE __LIB__ *freopen(const char *name, const char *mode, FILE *fp);
extern FILE __LIB__ *fdopen(const int fildes, const char *mode);
extern FILE __LIB__ *fmemopen(void *buf, size_t size, const char *mode);
...
extern char __LIB__ *fgets( char *s, int, FILE *fp);
extern int __LIB__ fputs( char *s,  FILE *fp);
...
extern int __LIB__ fputs(const char *s,  FILE *fp);
extern int __LIB__ fputc(int c, FILE *fp);

extern int __LIB__ __CALLEE__ fputs_callee(const char *s,  FILE *fp);
...
extern int __LIB__ __SAVEFRAME__ fseek(FILE *fp, fpos_t offset, int whence);
...
extern void __LIB__ printn(int number, int radix,FILE *file);
...
extern char __LIB__ *fgets_cons(char *s, size_t n);
...
/* Rename a file */
extern int __LIB__ rename(const char *s, const char *d);
/* Remove a file */
