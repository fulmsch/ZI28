...
extern void __LIB__ ellipse(int cx, int cy, int sa, int ea, int xradius, int yradius);
...
extern void __LIB__ polygon(int cx, int cy, int corners, int r, int sa);



/* As above but related to the "stencil" object */
extern void __LIB__ stencil_add_polygon(int cx, int cy, int corners, int r, int sa, unsigned char *stencil);
extern void __LIB__ stencil_add_ellipse(int cx, int cy, int sa, int ea, int xradius, int yradius, unsigned char *stencil);
