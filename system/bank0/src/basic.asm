...
DEFC CTRLC    = 0x03            ; Control "C"
DEFC CTRLG    = 0x07            ; Control "G"
DEFC BKSP     = 0x08            ; Back space
DEFC LF       = 0x0A            ; Line feed
DEFC CS       = 0x0C            ; Clear screen
DEFC CR       = 0x0D            ; Carriage return
DEFC CTRLO    = 0x0F            ; Control "O"
DEFC CTRLQ    = 0x11            ; Control "Q"
DEFC CTRLR    = 0x12            ; Control "R"
DEFC CTRLS    = 0x13            ; Control "S"
DEFC CTRLU    = 0x15            ; Control "U"
DEFC ESC      = 0x1B            ; Escape
DEFC DEL      = 0x7F            ; Delete

; BASIC WORK SPACE LOCATIONS

DEFC WRKSPC   = 0x4000            ; BASIC Work space
DEFC USR      = WRKSPC+0x0003        ; "USR (x)" jump
DEFC OUTSUB   = WRKSPC+0x0006        ; "OUT p,n"
DEFC OTPORT   = WRKSPC+0x0007        ; Port (p)
DEFC DIVSUP   = WRKSPC+0x0009        ; Division support routine
DEFC DIV1     = WRKSPC+0x000A        ; <- Values
DEFC DIV2     = WRKSPC+0x000E        ; <-   to
DEFC DIV3     = WRKSPC+0x0012        ; <-   be
DEFC DIV4     = WRKSPC+0x0015        ; <-inserted
DEFC SEED     = WRKSPC+0x0017        ; Random number seed
DEFC LSTRND   = WRKSPC+0x003A        ; Last random number
DEFC INPSUB   = WRKSPC+0x003E        ; #INP (x)" Routine
DEFC INPORT   = WRKSPC+0x003F        ; PORT (x)
DEFC NULLS    = WRKSPC+0x0041        ; Number of nulls
DEFC LWIDTH   = WRKSPC+0x0042        ; Terminal width
DEFC COMMAN   = WRKSPC+0x0043        ; Width for commas
DEFC NULFLG   = WRKSPC+0x0044        ; Null after input byte flag
DEFC CTLOFG   = WRKSPC+0x0045        ; Control "O" flag
DEFC LINESC   = WRKSPC+0x0046        ; Lines counter
DEFC LINESN   = WRKSPC+0x0048        ; Lines number
DEFC CHKSUM   = WRKSPC+0x004A        ; Array load/save check sum
DEFC NMIFLG   = WRKSPC+0x004C        ; Flag for NMI break routine
DEFC BRKFLG   = WRKSPC+0x004D        ; Break flag
DEFC RINPUT   = WRKSPC+0x004E        ; Input reflection
DEFC POINT    = WRKSPC+0x0051        ; "POINT" reflection (unused)
DEFC PSET     = WRKSPC+0x0054        ; "SET"   reflection
DEFC RESET    = WRKSPC+0x0057        ; "RESET" reflection
DEFC STRSPC   = WRKSPC+0x005A        ; Bottom of string space
DEFC LINEAT   = WRKSPC+0x005C        ; Current line number
DEFC BASTXT   = WRKSPC+0x005E        ; Pointer to start of program
DEFC BUFFER   = WRKSPC+0x0061        ; Input buffer
DEFC STACK    = WRKSPC+0x0066        ; Initial stack
DEFC CURPOS   = WRKSPC+0x00AB       ; Character position on line
DEFC LCRFLG   = WRKSPC+0x00AC       ; Locate/Create flag
DEFC TYPE     = WRKSPC+0x00AD       ; Data type flag
DEFC DATFLG   = WRKSPC+0x00AE       ; Literal statement flag
DEFC LSTRAM   = WRKSPC+0x00AF       ; Last available RAM
DEFC TMSTPT   = WRKSPC+0x00B1       ; Temporary string pointer
DEFC TMSTPL   = WRKSPC+0x00B3       ; Temporary string pool
DEFC TMPSTR   = WRKSPC+0x00BF       ; Temporary string
DEFC STRBOT   = WRKSPC+0x00C3       ; Bottom of string space
DEFC CUROPR   = WRKSPC+0x00C5       ; Current operator in EVAL
DEFC LOOPST   = WRKSPC+0x00C7       ; First statement of loop
DEFC DATLIN   = WRKSPC+0x00C9       ; Line of current DATA item
DEFC FORFLG   = WRKSPC+0x00CB       ; "FOR" loop flag
DEFC LSTBIN   = WRKSPC+0x00CC       ; Last byte entered
DEFC READFG   = WRKSPC+0x00CD       ; Read/Input flag
DEFC BRKLIN   = WRKSPC+0x00CE       ; Line of break
DEFC NXTOPR   = WRKSPC+0x00D0       ; Next operator in EVAL
DEFC ERRLIN   = WRKSPC+0x00D2       ; Line of error
DEFC CONTAD   = WRKSPC+0x00D4       ; Where to CONTinue
DEFC PROGND   = WRKSPC+0x00D6       ; End of program
DEFC VAREND   = WRKSPC+0x00D8       ; End of variables
DEFC ARREND   = WRKSPC+0x00DA       ; End of arrays
DEFC NXTDAT   = WRKSPC+0x00DC       ; Next data item
DEFC FNRGNM   = WRKSPC+0x00DE       ; Name of FN argument
DEFC FNARG    = WRKSPC+0x00E0       ; FN argument value
DEFC FPREG    = WRKSPC+0x00E4       ; Floating point register
DEFC FPEXP    = FPREG+3          ; Floating point exponent
DEFC SGNRES   = WRKSPC+0x00E8    ; Sign of result
DEFC PBUFF    = WRKSPC+0x00E9    ; Number print buffer
DEFC MULVAL   = WRKSPC+0x00F6    ; Multiplier
DEFC PROGST   = WRKSPC+0x00F9    ; Start of program text area
DEFC STLOOK   = WRKSPC+0x015D    ; Start of memory test

; BASIC ERROR CODE VALUES

DEFC NF       = 0x00            ; NEXT without FOR
DEFC SN       = 0x02            ; Syntax error
DEFC RG       = 0x04            ; RETURN without GOSUB
DEFC OD       = 0x06            ; Out of DATA
DEFC FC       = 0x08            ; Function call error
DEFC OV       = 0x0A            ; Overflow
DEFC OM       = 0x0C            ; Out of memory
DEFC UL       = 0x0E            ; Undefined line number
DEFC BS       = 0x10            ; Bad subscript
DEFC DD       = 0x12            ; Re-DIMensioned array
DEFC DZ       = 0x14            ; Division by zero (/0)
DEFC ID       = 0x16            ; Illegal direct
DEFC TM       = 0x18            ; Type miss-match
DEFC OS       = 0x1A            ; Out of string space
DEFC LS       = 0x1C            ; String too long
DEFC ST       = 0x1E            ; String formula too complex
DEFC CN       = 0x20            ; Can't CONTinue
DEFC UF       = 0x22            ; UnDEFined FN function
DEFC MO       = 0x24            ; Missing operand
DEFC HX       = 0x26            ; HEX error
DEFC BN       = 0x28            ; BIN error
...
BFREE:  DEFM    " Bytes free",CR,LF,0,0

SIGNON: DEFM    "Z80 BASIC Ver 4.7b",CR,LF
        DEFM    "Copyright ",40,'C',41
        DEFM    " 1978 by Microsoft",CR,LF,0,0

MEMMSG: DEFM    "Memory top",0
...
DEFC ZEND     = 0x80           ; END
DEFC ZFOR     = 0x81           ; FOR
DEFC ZDATA    = 0x83           ; DATA
DEFC ZGOTO    = 0x88           ; GOTO
DEFC ZGOSUB   = 0x8C           ; GOSUB
DEFC ZREM     = 0x8E           ; REM
DEFC ZPRINT   = 0x9E           ; PRINT
DEFC ZNEW     = 0xA4           ; NEW
...
DEFC ZFN      = 0xA7           ; FN
DEFC ZSPC     = 0xA8           ; SPC
DEFC ZTHEN    = 0xA9           ; THEN
DEFC ZNOT     = 0xAA           ; NOT
DEFC ZSTEP    = 0xAB           ; STEP
...
DEFC ZLTH     = 0xB5           ; <
DEFC ZSGN     = 0xB6           ; SGN
DEFC ZPOINT   = 0xC7           ; POINT
DEFC ZLEFT    = 0xCD+2         ; LEFT$

; ARITHMETIC PRECEDENCE TABLE

PRITAB: DEFB    0x79            ; Precedence value
        DEFW    PADD            ; FPREG = <last> + FPREG

        DEFB    0x79            ; Precedence value
        DEFW    PSUB            ; FPREG = <last> - FPREG

        DEFB    0x7C            ; Precedence value
        DEFW    MULT            ; PPREG = <last> * FPREG

        DEFB    0x7C            ; Precedence value
        DEFW    DIV             ; FPREG = <last> / FPREG

        DEFB    0x7F            ; Precedence value
        DEFW    POWER           ; FPREG = <last> ^ FPREG

        DEFB    0x50            ; Precedence value
        DEFW    PAND            ; FPREG = <last> AND FPREG

        DEFB    0x46            ; Precedence value
        DEFW    POR             ; FPREG = <last> OR FPREG

; BASIC ERROR CODE LIST

ERRORS: DEFM    "NF"            ; NEXT without FOR
...
INITAB: JP      WARMST          ; Warm start jump
        ...
        DEFB    0x35,0x4A,0xCA,0x99    ;-2.65145E+07
        DEFB    0x39,0x1C,0x76,0x98    ; 1.61291E+07
        DEFB    0x22,0x95,0xB3,0x98    ;-1.17691E+07
        DEFB    0x0A,0xDD,0x47,0x98    ; 1.30983E+07
        DEFB    0x53,0xD1,0x99,0x99    ;-2-01612E+07
        DEFB    0x0A,0x1A,0x9F,0x98    ;-1.04269E+07
        DEFB    0x65,0xBC,0xCD,0x98    ;-1.34831E+07
        DEFB    0xD6,0x77,0x3E,0x98    ; 1.24825E+07
        DEFB    0x52,0xC7,0x4F,0x80    ; Last random number
...
ERRMSG: DEFM    " Error",0
INMSG:  DEFM    " in ",0
DEFC ZERBYT   = OKMSG - 1             ; A zero byte
OKMSG:  DEFM    "Ok",CR,LF,0,0
BRKMSG: DEFM    "Break",0
...
SNERR:  LD      E,SN            ; ?SN Error
        DEFB    0x01            ; Skip "LD E,DZ"
DZERR:  LD      E,DZ            ; ?/0 Error
        DEFB    0x01            ; Skip "LD E,NF"
NFERR:  LD      E,NF            ; ?NF Error
        DEFB    0x01            ; Skip "LD E,DD"
DDERR:  LD      E,DD            ; ?DD Error
        DEFB    0x01            ; Skip "LD E,UF"
UFERR:  LD      E,UF            ; ?UF Error
        DEFB    0x01            ; Skip "LD E,OV
OVERR:  LD      E,OV            ; ?OV Error
        DEFB    0x01            ; Skip "LD E,TM"
...
TSTBRK: IN      A,(0x01)        ; Check input status
        BIT     1,A
        RET     NZ              ; No key, go back
        RST     RST_getc        ; Get the key into A
        CP      ESC             ; Escape key?
        JR      Z,BRK           ; Yes, break
        CP      CTRLC           ; <Ctrl-C>
        JR      Z,BRK           ; Yes, break
...
STALL:  RST     RST_getc        ; Wait for key
...
RETLIN: LD      HL,RUNCNT       ; Execution driver loop
        EX      (SP),HL         ; Into stack - Code string out
        DEFB       0x3E            ; Skip "POP HL"
NXTDTA: POP     HL              ; Restore code string address

DATA:   DEFB       0x01,0x3A        ; ':' End of statement
...
REDO:   DEFM    "?Redo from start",CR,LF,0
...
EXTIG:  DEFM    "?Extra ignored",CR,LF,0
...
TSTNUM: DEFB       0xF6           ; Clear carry (numeric)
...
DIM:    LD      BC,DIMRET       ; Return to "DIMRET"
        ...
        DEFB       0xF6           ; Flag "Create" variable
...
TESTR:  OR      A               ; Test if enough room
        DEFB       0x0E            ; No garbage collection done
...
SUBPHL: CALL    LOADFP          ; FPREG = -FPREG + number at HL
        DEFB       0x21            ; Skip "POP BC" and "POP DE"
...
UNITY:  DEFB        0x00,0x00,0x00,0x81   ; 1.00000

LOGTAB: DEFB       3                       ; Table used by LOG
        DEFB       0xAA,0x56,0x19,0x80    ; 0.59898
        DEFB       0xF1,0x22,0x76,0x80    ; 0.96147
        DEFB       0x45,0xAA,0x38,0x82    ; 2.88539
...
DIVLP:  PUSH    HL              ; Save divisor
        ...
        POP     AF
        SCF                     ; Set carry to
        DEFB       0xD2           ; Skip "POP BC" and "POP HL"
...
HALF:   DEFB       0x0,0x0,0x0,0x80; 0.5

POWERS: DEFB       0xA0,0x86,0x01 ; 100000
...
EXPTAB: DEFB       8                       ; Table used by EXP
        DEFB       0x40,0x2E,0x94,0x74    ; -1/7! (-1/5040)
        DEFB       0x70,0x4F,0x2E,0x77    ;  1/6! ( 1/720)
        DEFB       0x6E,0x02,0x88,0x7A    ; -1/5! (-1/120)
        DEFB       0xE6,0xA0,0x2A,0x7C    ;  1/4! ( 1/24)
        DEFB       0x50,0xAA,0xAA,0x7E    ; -1/3! (-1/6)
        DEFB       0xFF,0xFF,0x7F,0x7F    ;  1/2! ( 1/2)
        DEFB       0x00,0x00,0x80,0x81    ; -1/1! (-1/1)
        DEFB       0x00,0x00,0x00,0x81    ;  1/0! ( 1/1)
...
RNDTAB: DEFB    0x68,0xB1,0x46,0x68    ; Table used by RND
        DEFB    0x99,0xE9,0x92,0x69
        DEFB    0x10,0xD1,0x75,0x68
...
HALFPI: DEFB    0xDB,0x0F,0x49,0x81    ; 1.5708 (PI/2)

QUARTR: DEFB    0x00,0x00,0x00,0x7F    ; 0.25

SINTAB: DEFB    5                       ; Table used by SIN
        DEFB    0xBA,0xD7,0x1E,0x86    ; 39.711
        DEFB    0x64,0x26,0x99,0x87    ;-76.575
        DEFB    0x58,0x34,0x23,0x87    ; 81.602
        DEFB    0xE0,0x5D,0xA5,0x86    ;-41.342
        DEFB    0xDA,0x0F,0x49,0x83    ;  6.2832
...
ATNTAB: DEFB    9                       ; Table used by ATN
        DEFB    0x4A,0xD7,0x3B,0x78    ; 1/17
        DEFB    0x02,0x6E,0x84,0x7B    ;-1/15
        DEFB    0xFE,0xC1,0x2F,0x7C    ; 1/13
        DEFB    0x74,0x31,0x9A,0x7D    ;-1/11
        DEFB    0x84,0x3D,0x5A,0x7D    ; 1/9
        DEFB    0xC8,0x7F,0x91,0x7E    ;-1/7
        DEFB    0xE4,0xBB,0x4C,0x7E    ; 1/5
        DEFB    0x6C,0xAA,0xAA,0x7F    ;-1/3
        DEFB    0x00,0x00,0x00,0x81    ; 1/1


ARET:   RET                     ; A RETurn instruction

GETINP: RST     RST_getc        ;input a character
        RET

CLS:
        LD      HL,CLEARSTR
        JP      PRS
CLEARSTR: DEFM 0x1b, "[2J", 0x1b, "[H", 0x00
