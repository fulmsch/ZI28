...
run:
	tmux split-window -hd "sleep 1; picocom /tmp/zi28tty --omap crcrlf,delbs --send-cmd 'ascii-xfr -snvde' --receive-cmd 'ascii-xfr -rne'" && emulator/zi28emu -r system/rom.bin -c user/sd.img
